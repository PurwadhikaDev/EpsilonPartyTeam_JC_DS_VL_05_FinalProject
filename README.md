...
4. Serta jika dibandingkan dengan sebelum di hyperparam tuning, didapatkan nilai recall meningkat dari 94,4% menjadi 95,06% dan nilai FN menurun dari 9 menjadi 8.

**Secara keseluruhan model hasil dari feature importance dengan model yang dipilih XGBoost dan metode undersampling memberikan nilai recall dan FN yang paling baik yaitu recall score : 95,06% dan FN : 8**
